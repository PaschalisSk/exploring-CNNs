...
for experiment_name in experiment_names:
    ...
    dfs['cum_mean_time'] = dfs.epoch_time_mean.cumsum()
    line = ax.plot(dfs['cum_mean_time'].values, dfs['val_acc_mean'].values,
                   linewidth=1)[0]
    label = ''
...
ax.legend()
fig.savefig(str(graphs_folder / 'valTimes.eps'), bbox_inches='tight')
fig.show()
