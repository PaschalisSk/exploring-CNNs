...
args.use_gpu = True
seeds = [0, 1, 2]
dim_reduction_types = ['strided_convolution', 'dilated_convolution', 'max_pooling']
initial_num_filters = 16
for seed in seeds:
    for dim_reduction_type in dim_reduction_types:
        args.seed = seed
        args.dim_reduction_type = dim_reduction_type
        args.num_filters = initial_num_filters
        args.experiment_name = 'exp.' + dim_reduction_type + '.seed.' + str(seed)
